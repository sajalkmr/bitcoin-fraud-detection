...
cohen = cohen_kappa_score(y_test, pred_RF)
print(f'Cohen kappa score: {cohen}')

mathews_coef = matthews_corrcoef(y_test, pred_RF)
print(f'Mathews correlation coeficient: {mathews_coef}')
...
cohen = cohen_kappa_score(y_test, pred_XGB)
print(f'Cohen kappa score: {cohen}')
mathews_coef = matthews_corrcoef(y_test, pred_XGB)
print(f'Mathews correlation coeficient: {mathews_coef}')
