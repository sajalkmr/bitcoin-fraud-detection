...
def supervised_model(X_train, y_train, model, **kwargs):
    """ Use models from the sklearn library with optional hyperparameters """

    if model == 'RandomForest':         
        model_supervised = RandomForestClassifier(**kwargs)
    elif model == 'XGBoost':
        model_supervised = XGBClassifier(use_label_encoder=False, eval_metric='logloss', **kwargs)
    else:
